...
/**
 * Shiro防止中文Restful请求被拦截
 *
 * @author fangen
 * @since JDK 11  2022/4/15
 **/
@Component
public class CNInvalidRequestFilter extends AccessControlFilter {
    private static final List<String> SEMICOLON = List.of(";", "%3b", "%3B");
    private static final List<String> BACKSLASH = List.of("\\", "%5c", "%5C");
