...
echo "------------------------------------------------------------------" >> "$STDOUT_FILE"
START_TIME=$(date +%s)
echo "$(get_timestamp) - [main]Script: $(basename $0) execution start..." >> "$STDOUT_FILE"
...
echo "$(get_timestamp) - [main]Script: $(basename $0) execution ended. Total execution time: $DURATION seconds." >> "$STDOUT_FILE"
echo "------------------------------------------------------------------" >> "$STDOUT_FILE"
